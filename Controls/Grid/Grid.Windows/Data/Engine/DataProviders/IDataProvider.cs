...
namespace Telerik.Data.Core
{
    ...
    internal interface IDataProvider : INotifyPropertyChanged, ISupportInitialize
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="IDataSettings"/> instance that is being used.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a property that indicates if changes to the grouping settings would trigger computations immediately when invalidated or on explicit <see cref="Refresh"/>.
        /// </summary>
