...
namespace Telerik.UI.Xaml.Controls.Grid
{
    ...
    internal class LocalDataSourceProvider : DataProviderBase
    {
        ...
        public LocalDataSourceProvider()
            : this(new ParallelDataEngine())
        {
        }

        internal LocalDataSourceProvider(IDataEngine engine)
            : this(engine, null)
        {
        }

        internal LocalDataSourceProvider(IDataEngine engine, IFieldDescriptionProvider fieldInfoProvider)
            : this(new DataSettings<PropertyFilterDescriptionBase, PropertyGroupDescriptionBase, PropertyAggregateDescriptionBase, SortDescription>(), engine, fieldInfoProvider)
        {
        }

        internal LocalDataSourceProvider(DataSettings<PropertyFilterDescriptionBase, PropertyGroupDescriptionBase, PropertyAggregateDescriptionBase, SortDescription> settings, IDataEngine engine, IFieldDescriptionProvider fieldInfoProvider)
            : base(settings, fieldInfoProvider)
        {
        ...
        {
            get { return this.isSingleThreaded; }
            set { this.isSingleThreaded = value; }
        }
        ...
        /// <summary>
        /// A list of <see cref="PropertyGroupDescriptionBase"/> that specified how the data should be grouped by rows.
        /// </summary>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists", Justification = "Design choice.")]
        ...
        /// <summary>
        /// A list of <see cref="PropertyGroupDescriptionBase"/> that specified how the data should be grouped by columns.
        /// </summary>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists", Justification = "Design choice.")]
        ...
        /// </summary>
        protected virtual bool FieldDescriptionsReadyForUpdate
        {
            get
            {
                return this.FieldDescriptionsProvider != null && !this.FieldDescriptionsProvider.IsBusy && this.ItemsSource != null;
            }
        }
        ...
        private class LocalSourceValueProvider : IValueProvider
        {
            ...
            public IReadOnlyList<PropertyGroupDescriptionBase> RowGroupDescriptions
            {
                get;
                set;
            }

            public IReadOnlyList<PropertyGroupDescriptionBase> ColumnGroupDescriptions
            {
                get;
                set;
            }

            public IReadOnlyList<PropertyAggregateDescriptionBase> AggregateDescriptions
            {
                get;
                set;
            }

            public IReadOnlyList<PropertyFilterDescriptionBase> FilterDescriptions
            {
                get;
                set;
            }
