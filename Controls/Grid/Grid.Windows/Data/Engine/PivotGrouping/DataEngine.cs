    ...
    internal partial class ParallelDataEngine : IDataEngine
    {
        ...
        private static GroupingResults ProcessItems(object state)
        {
            ...
            for (int index = start; index < end; index++)
            {
                ...
                var coordinate = AddItem(parallelState.ValueProvider, rowRootGroup, columnRootGroup, fact, groupFactory);
        ...
        private static Coordinate AddItem(IValueProvider valueProvider, Group rowRootGroup, Group columnRootGroup, object item, IGroupFactory groupFactory)
        {
        ...
        private class BottomLevelGroupingTaskState
        {
            ...
            internal ParallelState ParallelState
            {
                get;
                set;
            }
        ...
        {
            internal GroupingResults Results
            {
                get;
                set;
            }
