...
{
    /// <summary>
    /// Represents the context that is passed to a <see cref="Primitives.DataGridGroupHeader"/> control that represents a <see cref="IDataGroup"/> within a <see cref="RadDataGrid"/> instance.
    /// </summary>
    public class GroupHeaderContext : ViewModelBase
    {
        ...
        /// <summary>
        /// Gets the <see cref="RadDataGrid"/> instance that provides the grouping context.
        /// </summary>
        public RadDataGrid Grid
        {
            get;
            internal set;
        }
