...
namespace Telerik.UI.Xaml.Controls.Grid.Commands
{
    ...
    public sealed class DataGridUserCommand : DataGridCommand
    {
        ...
        public static readonly DependencyProperty CommandProperty =
            DependencyProperty.Register("Command", typeof(ICommand), typeof(DataGridUserCommand), new PropertyMetadata(null, OnCommandChanged));
        ...
        public static readonly DependencyProperty EnableDefaultCommandProperty =
            DependencyProperty.Register("EnableDefaultCommand", typeof(bool), typeof(DataGridUserCommand), new PropertyMetadata(true, OnEnableDefaultCommandChanged));
