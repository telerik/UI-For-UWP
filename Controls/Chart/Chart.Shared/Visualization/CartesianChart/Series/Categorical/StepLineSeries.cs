...
namespace Telerik.UI.Xaml.Controls.Chart
{
    ...
    public class StepLineSeries : LineSeries
    {
        ...
        public static readonly DependencyProperty RisersPositionProperty =
            DependencyProperty.Register("RisersPosition", typeof(StepSeriesRisersPosition), typeof(StepLineSeries), new PropertyMetadata(StepSeriesRisersPosition.Default, OnRisersPositionChanged));
