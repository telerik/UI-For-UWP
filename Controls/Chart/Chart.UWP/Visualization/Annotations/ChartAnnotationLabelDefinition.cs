...
namespace Telerik.UI.Xaml.Controls.Chart
{
    ...
    public class ChartAnnotationLabelDefinition : DependencyObject
    {
        ...
        public static readonly DependencyProperty FormatProperty =
            DependencyProperty.Register("Format", typeof(string), typeof(ChartAnnotationLabelDefinition), new PropertyMetadata(null));

        /// <summary>
        /// Identifies the <see cref="Template"/> property.
        /// </summary>
        public static readonly DependencyProperty TemplateProperty =
            DependencyProperty.Register("Template", typeof(DataTemplate), typeof(ChartAnnotationLabelDefinition), new PropertyMetadata(null));

        /// <summary>
        /// Identifies the <see cref="DefaultVisualStyle"/> property.
        /// </summary>
        public static readonly DependencyProperty DefaultVisualStyleProperty =
            DependencyProperty.Register("DefaultVisualStyle", typeof(Style), typeof(ChartAnnotationLabelDefinition), new PropertyMetadata(null));

        /// <summary>
        /// Identifies the <see cref="Location"/> property.
        /// </summary>
        public static readonly DependencyProperty LocationProperty =
            DependencyProperty.Register("Location", typeof(ChartAnnotationLabelLocation), typeof(ChartAnnotationLabelDefinition), new PropertyMetadata(ChartAnnotationLabelLocation.Left));

        /// <summary>
        /// Identifies the <see cref="HorizontalAlignment"/> property.
        /// </summary>
        public static readonly DependencyProperty HorizontalAlignmentProperty =
            DependencyProperty.Register("HorizontalAlignment", typeof(HorizontalAlignment), typeof(ChartAnnotationLabelDefinition), new PropertyMetadata(HorizontalAlignment.Left));

        /// <summary>
        /// Identifies the <see cref="VerticalAlignment"/> property.
        /// </summary>
        public static readonly DependencyProperty VerticalAlignmentProperty =
            DependencyProperty.Register("VerticalAlignment", typeof(VerticalAlignment), typeof(ChartAnnotationLabelDefinition), new PropertyMetadata(VerticalAlignment.Top));

        /// <summary>
        /// Identifies the <see cref="HorizontalOffset"/> property.
        /// </summary>
        public static readonly DependencyProperty HorizontalOffsetProperty =
            DependencyProperty.Register("HorizontalOffset", typeof(double), typeof(ChartAnnotationLabelDefinition), new PropertyMetadata(0d));

        /// <summary>
        /// Identifies the <see cref="VerticalOffset"/> property.
        /// </summary>
        public static readonly DependencyProperty VerticalOffsetProperty =
            DependencyProperty.Register("VerticalOffset", typeof(double), typeof(ChartAnnotationLabelDefinition), new PropertyMetadata(0d));
