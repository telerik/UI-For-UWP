...
namespace Telerik.UI.Xaml.Controls.Chart
{
    ...
    public class ChartSeriesLabelDefinition : DependencyObject
    {
        ...
        public static readonly DependencyProperty BindingProperty =
            DependencyProperty.Register("Binding", typeof(DataPointBinding), typeof(ChartSeriesLabelDefinition), new PropertyMetadata(null));

        /// <summary>
        /// Identifies the <see cref="Format"/> property.
        /// </summary>
        public static readonly DependencyProperty FormatProperty =
            DependencyProperty.Register("Format", typeof(string), typeof(ChartSeriesLabelDefinition), new PropertyMetadata(null));

        /// <summary>
        /// Identifies the <see cref="Margin"/> property.
        /// </summary>
        public static readonly DependencyProperty MarginProperty =
            DependencyProperty.Register("Margin", typeof(Thickness), typeof(ChartSeriesLabelDefinition), new PropertyMetadata(new Thickness(0)));

        /// <summary>
        /// Identifies the <see cref="HorizontalAlignment"/> property.
        /// </summary>
        public static readonly DependencyProperty HorizontalAlignmentProperty =
            DependencyProperty.Register("HorizontalAlignment", typeof(HorizontalAlignment), typeof(ChartSeriesLabelDefinition), new PropertyMetadata(HorizontalAlignment.Left));

        /// <summary>
        /// Identifies the <see cref="VerticalAlignment"/> property.
        /// </summary>
        public static readonly DependencyProperty VerticalAlignmentProperty =
            DependencyProperty.Register("VerticalAlignment", typeof(VerticalAlignment), typeof(ChartSeriesLabelDefinition), new PropertyMetadata(VerticalAlignment.Top));

        /// <summary>
        /// Identifies the <see cref="Template"/> property.
        /// </summary>
        public static readonly DependencyProperty TemplateProperty =
            DependencyProperty.Register("Template", typeof(DataTemplate), typeof(ChartSeriesLabelDefinition), new PropertyMetadata(null));

        /// <summary>
        /// Identifies the <see cref="TemplateSelector"/> property.
        /// </summary>
        public static readonly DependencyProperty TemplateSelectorProperty =
            DependencyProperty.Register("TemplateSelector", typeof(DataTemplateSelector), typeof(ChartSeriesLabelDefinition), new PropertyMetadata(null));

        /// <summary>
        /// Identifies the <see cref="DefaultVisualStyle"/> property.
        /// </summary>
        public static readonly DependencyProperty DefaultVisualStyleProperty =
            DependencyProperty.Register("DefaultVisualStyle", typeof(Style), typeof(ChartSeriesLabelDefinition), new PropertyMetadata(null));

        /// <summary>
        /// Identifies the <see cref="DefaultVisualStyle"/> property.
        /// </summary>
        public static readonly DependencyProperty StrategyProperty =
            DependencyProperty.Register("Strategy", typeof(ChartSeriesLabelStrategy), typeof(ChartSeriesLabelDefinition), new PropertyMetadata(null));
