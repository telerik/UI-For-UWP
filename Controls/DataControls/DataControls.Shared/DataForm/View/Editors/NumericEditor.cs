...
namespace Telerik.UI.Xaml.Controls.Data
{
    public class NumericEditor : RadNumericBox, ITypeEditor
    {
        ...
        public static readonly DependencyProperty ErrorIconStyleProperty =
            DependencyProperty.Register("ErrorIconStyle", typeof(Style), typeof(NumericEditor), new PropertyMetadata(null));     
        ...
        public static readonly DependencyProperty HasErrorsProperty =
            DependencyProperty.Register("HasErrors", typeof(bool), typeof(NumericEditor), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty LabelIconStyleProperty =
            DependencyProperty.Register("LabelIconStyle", typeof(Style), typeof(NumericEditor), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty IconDisplayModeProperty =
            DependencyProperty.Register("IconDisplayMode", typeof(EditorIconDisplayMode), typeof(NumericEditor), new PropertyMetadata(EditorIconDisplayMode.None));
