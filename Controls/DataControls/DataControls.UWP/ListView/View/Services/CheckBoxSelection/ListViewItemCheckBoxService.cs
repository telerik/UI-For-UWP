...
#pragma warning restore 0067
        ...
        public ListViewItemCheckBoxService(RadListView owner)
            : base(owner)
        {
            containerGenerator = new CheckBoxesContainerGenerator(this);
            this.generator = new CheckBoxGenerator(containerGenerator);
        }
        ...
        public void PrepareContainerForItem(GeneratedItemModel element)
        {
            ...
            if(control != null)
            {
                ...
                if (selectedItems.Contains(element.ItemInfo.Item))
                {
        ...
        public void ArrangeVisuals()
        {
            ...
            foreach (var item in this.Owner.Model.ForEachDisplayedElement())
            {
                ...
                if (!itemsAnimated && this.Owner.checkBoxLayerCache.GetGeneratedContainersCount() > 0)
                {
