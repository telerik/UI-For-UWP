...
namespace Telerik.UI.Xaml.Controls.Data
{
    public class TimeEditor : RadTimePicker, ITypeEditor
    {
        ...
        public static readonly DependencyProperty IconDisplayModeProperty =
            DependencyProperty.Register("IconDisplayMode", typeof(EditorIconDisplayMode), typeof(TimeEditor), new PropertyMetadata(EditorIconDisplayMode.None));
        ...
        public static readonly DependencyProperty ErrorIconStyleProperty =
            DependencyProperty.Register("ErrorIconStyle", typeof(Style), typeof(TimeEditor), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty HasErrorsProperty =
            DependencyProperty.Register("HasErrors", typeof(bool), typeof(TimeEditor), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty LabelIconStyleProperty =
            DependencyProperty.Register("LabelIconStyle", typeof(Style), typeof(TimeEditor), new PropertyMetadata(null));
