...
namespace Telerik.Data.Core
{
    ...
    internal interface IDataResults : IAggregateResultProvider
    {
        ...
        /// <summary>
        /// Gets a read-only collection of the <see cref="GroupDescription"/>s used to generate the <see cref="IAggregateResultProvider.Root"/>'s <see cref="Coordinate.RowGroup"/> <see cref="IGroup"/>s tree.
        /// </summary>
        IReadOnlyList<GroupDescription> RowGroupDescriptions { get; }

        /// <summary>
        /// Gets a read-only collection of the <see cref="GroupDescription"/>s used to generate the <see cref="IAggregateResultProvider.Root"/>'s <see cref="Coordinate.ColumnGroup"/> <see cref="IGroup"/>s tree.
        /// </summary>
        IReadOnlyList<GroupDescription> ColumnGroupDescriptions { get; }

        /// <summary>
        /// Gets a read-only collection of the <see cref="IAggregateDescription"/> used to generate the the available <see cref="AggregateValue"/>s for the <see cref="GetAggregateResult"/>.
        /// </summary>
        IReadOnlyList<IAggregateDescription> AggregateDescriptions { get; }

        /// <summary>
        /// Gets a read-only collection of the <see cref="FilterDescription"/> used to filter the items.
        /// </summary>
